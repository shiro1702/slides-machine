...
export const MSG = {
  ...
  howItWorks:
    "1) Выбери нишу\n2) Напиши тему\n3) Выбери стиль\n4) Получишь PNG-карусель альбомом в чат\n\n" +
    "Команды: /new · /cancel",
  ...
  rendering:
    "Структура готова. Рендерю слайды в PNG — обычно меньше минуты…",

  success: (title: string, projectId: string) =>
    `Готово! «${title}»\nID: ${projectId}\n\nАльбом выше — можно сохранять и публиковать. /new — ещё одна карусель.`,

  albumCaption: (title: string) =>
    `«${title}» — свайпай альбом. Сохрани себе или выложи в канал.`,

  renderFailed:
    "Не удалось отрендерить или отправить карусель. Попробуй /new ещё раз.",
